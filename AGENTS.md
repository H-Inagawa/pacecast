...
- ホームの導線カードは上から「パフォーマンスを予測」「走行記録」「ランニング天気予報」「分析結果」「PaceCastとは？」。見出しは「天気から、走りを予報する。」。先頭3つは大きく（スマホ 320×160・カード内リードあり）、分析は 320×100、については 320×80（文言・PC 寸法は Figma / [#22](https://github.com/H-Inagawa/pacecast/issues/22)）。設定はヘッダ右上の歯車
