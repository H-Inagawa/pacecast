...
- 日本語のフォントは Noto Serif JP。見出しは Black、本文は Regular。ロゴ PaceCast も同じ（イタリックは使わない）
- ヘッダは高さ 60px。左にドロワー（60px）、中央にロゴ（下に「○○ さん」）、右に設定（60px）。今いる画面は強調して選べない。ロゴはホーム。ヘッダはスクロールしても画面上部に固定
